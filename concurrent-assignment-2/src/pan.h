...
#define nstates1	38	/* PU */
#define endstate1	37
short src_ln1 [] = {
	  0,  56,  14,  14,  14,  14,  60,  14, 
	 14,  14,  14,  61,  61,  60,  63,  63, 
	 64,  13,  13,  66,  69,  70,  71,  72, 
	 75,  76,  77,  13,  13,  78,  78,  77, 
	 80,  80,  56,  82,  56,  82,   0, };
S_F_MAP src_file1 [] = {
	{ ""-"", 0, 0 },
	{ "Man2multi.pml", 1, 37 },
...
#define nstates0	38	/* PD */
#define endstate0	37
short src_ln0 [] = {
	  0,  25,  14,  14,  14,  14,  28,  14, 
	 14,  14,  14,  29,  29,  28,  31,  31, 
	 32,  13,  13,  34,  37,  38,  39,  40, 
	 43,  44,  45,  13,  13,  46,  46,  45, 
	 48,  48,  25,  50,  25,  50,   0, };
S_F_MAP src_file0 [] = {
	{ ""-"", 0, 0 },
	{ "Man2multi.pml", 1, 37 },
...
#define PPU	((P1 *)this)
typedef struct P1 { /* PU */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
	int _2_upTemp;
} P1;
#define Air1	(sizeof(P1) - Offsetof(P1, _2_upTemp) - 1*sizeof(int))
#define PPD	((P0 *)this)
typedef struct P0 { /* PD */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
	int _1_downTemp;
} P0;
#define Air0	(sizeof(P0) - Offsetof(P0, _1_downTemp) - 1*sizeof(int))
