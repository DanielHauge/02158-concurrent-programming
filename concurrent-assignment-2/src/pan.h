...
#define endstate1	35
short src_ln1 [] = {
	  0,  54,  14,  14,  14,  14,  58,  14, 
	 14,  14,  14,  58,  59,  59,  60,  61, 
	 13,  13,  63,  66,  67,  68,  69,  72, 
	 73,  74,  75,  13,  13,  75,  76,  76, 
	 54,  78,  54,  78,   0, };
S_F_MAP src_file1 [] = {
	{ ""-"", 0, 0 },
	{ "Man2multi.pml", 1, 35 },
...
#define nstates0	36	/* PD */
#define endstate0	35
short src_ln0 [] = {
	  0,  25,  14,  14,  14,  14,  28,  14, 
	 14,  14,  14,  28,  29,  29,  30,  31, 
	 13,  13,  33,  36,  37,  38,  39,  42, 
	 43,  44,  45,  13,  13,  45,  46,  46, 
	 25,  48,  25,  48,   0, };
S_F_MAP src_file0 [] = {
	{ ""-"", 0, 0 },
	{ "Man2multi.pml", 1, 35 },
