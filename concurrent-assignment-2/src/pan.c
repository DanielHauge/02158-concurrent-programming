...
/*** From source: assignment2-p3.pml ***/
...
#ifdef VAR_RANGES
		logval("PU:upTemp", ((P1 *)pptr(h))->_2_upTemp);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
...
#ifdef VAR_RANGES
		logval("PD:downTemp", ((P0 *)pptr(h))->_1_downTemp);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	printf("global vars:\n");
	printf("	int    incritUp:	%d\n", now.incritUp);
	printf("	int    incritDown:	%d\n", now.incritDown);
	printf("	int    upSem:	%d\n", now.upSem);
...
{	/* int i; */
	switch(tp) {
	case 1:
		printf("local vars proc %d (PU):\n", pid);
	printf("	int    upTemp:	%d\n", ((P1 *)pptr(pid))->_2_upTemp);
		break;
	case 0:
		printf("local vars proc %d (PD):\n", pid);
	printf("	int    downTemp:	%d\n", ((P0 *)pptr(pid))->_1_downTemp);
		break;
	}
}
void
